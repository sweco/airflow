...
@cache
def get_logs_task_metadata(config_prefix=...) -> bool:
    return conf.getboolean(config_prefix + "kubernetes_executor", "logs_task_metadata")


def annotations_for_logging_task_metadata(annotation_set, config_prefix=...):
    if get_logs_task_metadata(config_prefix=config_prefix):
